    ...
    <Shell>
      <div className="mt-5 flex flex-col items-start gap-4 sm:mt-10 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-[13px] text-foreground/65">
            Your own comics live in this browser only. They are loaded from local history, not the public library.
          </p>
        </div>
        <Link
          href="/new"
      ...
      {projects.length === 0 ? (
        <div className="mt-10 rounded-2xl border border-subtle bg-surface p-10 text-center">
          <History className="mx-auto h-6 w-6 text-foreground/50" />
          <div className="mt-3 text-[13.5px] text-foreground/70">
            No local history yet. Start a comic and it will appear here.
          </div>
          <Link
            href="/new"
